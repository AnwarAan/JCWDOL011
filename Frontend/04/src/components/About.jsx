    ...
    <section id="about">
      <div>
        ...
        <p>
          ...
          5 years and I want to become an Indonesian HR who is able to compete
          on an international scale in the field of technology
        </p>
      </div>
      <section>
        <h2>Skills</h2>
        ...
        <div className="flex justify-center">
          <div className="card">
            <div className="mt-10 mx-3">
              <h4>Backend application CRUD user</h4>
            </div>
            <div className="my-2 mx-3">
              <h6>
                Typescript, Node Js, Postman, JWT, Nodemailer, Clean Code, CQRS
              </h6>
              <button>
                <a href="https://github.com/AnwarAan/Mini-App.git">Click Me</a>
              </button>
            </div>
          </div>
        </div>
